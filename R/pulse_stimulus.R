...
#' @param as_array logical; if TRUE, return as 3d array (2 x timepoints x trials). If FALSE, return as list. default=TRUE
#'
#' @return stimulus train
#'
#' @export
pulse_stimulus <- function(up_sequence, down_sequence=NULL, pattern="", dur=0.01, isi=0.1, pre_stim=0, dt=0.001, as_array=T){
